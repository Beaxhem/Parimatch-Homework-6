//
//  UICollectionViewFetchedResultsControllable.swift
...
protocol UICollectionViewFetcedResultControllable: NSFetchedResultsControllerDelegate {
...
class UICollectionViewFetchedResultsController<T: NSFetchRequestResult>: NSObject,
                                                                         UICollectionViewFetcedResultControllable {
    ...
    private lazy var sectionChanges = [(type: NSFetchedResultsChangeType,
                                   sectionIndex: Int)]()
    private lazy var objectChanges = [(type: NSFetchedResultsChangeType,
                                  indexPath: IndexPath?,
